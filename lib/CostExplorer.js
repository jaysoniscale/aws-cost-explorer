 ...
 * @param {opts} object Optional { granularity : "MONTHLY" | "DAILY", metrics : "BlendedCost" | "UnblendedCost", start : "YYYY-MM-DD", end : "YYYY-MM-DD" }
 * @param {callback} Callback function
 */
method.getDateRangeCosts = function(opts, callback) {
    ...
    var StartDate = opts && opts.start ? opts.start : "1999-01-01";
    var EndDate = opts && opts.end ? opts.end : "1999-01-01";
    var metrics = opts && opts.metrics ? opts.metrics : "BlendedCost";
    var granularity = opts && opts.granularity ? opts.granularity : "MONTHLY";
...
function getAggregatedCosts(data, metrics) {
    ...
    Object.keys(data.ResultsByTime).forEach(function(key) {
        ...
        unit = data.ResultsByTime[key].Total.UnblendedCost.Unit;
      });
